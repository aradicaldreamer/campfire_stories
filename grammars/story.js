module.exports = {
    ...
    truth: ["true"],
    tale: ["story", "tale"],
    sceneOne: ["To protect the people that are still living in this story, I'll need a name. What's one that you like? Be careful, It shouldn't be yours!"],
    ...
    fear: ["clowns"],
    greed: ["treasure"],
    questionFour: ["I should tell you that #playerCharacter.capitalize# is terrified of [playerCharacterFear: #fear#]#playerCharacterFear#. What are you afraid of?"],
    sceneSix: ["#playerCharacter.capitalize# heard a noise around the corner, and immediately they began worrying if it might be#playerCharacterFear#. They #adverb1# grabbed the nearest #murderWeapon# and shut their eyes tight."],
    murderWeapon: ["stone", "heavy object"],
    sceneSeven: ["They heard rustling coming towards them. Shuffle, shuffle shuffle."],
    sceneEight: ["Terrified, #playerCharacter.capitalize# swung with all their might. THUD. They opened their eyes, not to find #playerCharacterFear# but rather their friend [friendName: #names.capitalize#]#friendName#"],
    sceneNine: ["While checking for breathing, #playerCharacter.capitalize# let blood pool around their shoes. Their friend was definitely dead, so they ran"],
    sceneTen: ["#playerCharacter.capitalize# never told anyone what happened that day, and despite the efforts of the town police, they never found #friendName#"],
    ...
    endingOne: ["I should tell you that I haven't been entirely truthful with you."],
    endingTwo: ["My name isn't #narrator#, it's #friendName#. And I've been waiting out here, in #playerCharacter.capitalize#'s favorite place for years waiting for my revenge."],
    endingQuestion: ["Come to think of it, you haven't yet told me your name yet. People can change over such a long time. What is your name?"],
    endingThree: ["I don't believe you. But then again, I didn't believe the last visitor either. Now come a little closer to this here fire ..."],
    endingFour: ["THE END"],
